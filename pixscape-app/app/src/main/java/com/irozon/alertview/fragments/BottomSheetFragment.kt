...
class BottomSheetFragment(private val title: String,
                          private val message: String,
                          private val actions: ArrayList<AlertAction>,
                          private val style: AlertStyle,
            ...
            if (context != null) {
                when (action.style) {
                    AlertActionStyle.POSITIVE -> {
                        view.tvAction.setTextColor(ContextCompat.getColor(context!!, R.color.scape_blue))
                    }
                    ...
                    AlertActionStyle.DEFAULT -> {
                        if (theme == AlertTheme.LIGHT)
                            view.tvAction.setTextColor(ContextCompat.getColor(context!!, R.color.color_primary_dark))
                        else if (theme == AlertTheme.DARK)
                            view.tvAction.setTextColor(ContextCompat.getColor(context!!, R.color.color_white))
                    }
